...
export default class Page7 extends BasePage{
    constructor(info){
        super(info);
        this.bgPlayer = null;
        this.canvas;
    ...
    _init(){
        this.bgPlayer = new nc.promokit.Player({
            selector: '#page7-bg',
            videoId: 'http://vodfile.ncsoft.co.kr/ncvod/plaync/Aion/7update/E03.mp4',
            mute: true,
            controls: false,
            coverClick: false,
            loop: true
        ...
        this.canvasBgImg = new PIXI.Sprite.fromImage(appInfo.staticPath+'/promo/aion/history/2018/181128_color/img/page7/page7_bg.jpg');
    ...
    _motionSet(){
        ...
        this.showMotion
            ...
            .fromTo(this.ele.querySelector('.content .btn-link-7'), 0.5, { autoAlpha: 0, y: 50, },{ autoAlpha: 1, y: 0, ease: Quart.easeOut }, '-=0.3')
